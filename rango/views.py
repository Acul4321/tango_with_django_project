...
def index(request):
    ...
    # Render the response, updating any cookies that need changed.
...
def show_category(request, category_name_slug):
    ...
    except Category.DoesNotExist: # we didn't find the specified category.
...
def register(request):
    ...
    if request.method == 'POST': # start proccessing form
